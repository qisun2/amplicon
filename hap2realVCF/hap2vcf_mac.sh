...
ls $fastqDir/*fastq | xargs -S 2000 -I {} basename {} | sed "s/.fastq//" | xargs -S 2000 -I {} echo "bwa mem -t 2 -R \"@RG\tID:{}\tSM:{}\tLB:{}\tPL:ILLUMINA\" $refGenome $fastqDir/{}.fastq | samtools sort -O bam -o bam/{}.bam" > tasks_align
