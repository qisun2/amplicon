...
def main():
    ...
    parser.add_argument('-a','--maf',type=float,required=False,default=0.01,help='Minimum minor allele frequency Default:0.05')
    parser.add_argument('-l','--minHaplotypeLength',type=int,required=False,default=50,help='Minimum haplotype length (after removing the primers. It must be an integer 1 or larger.) Default:75')
